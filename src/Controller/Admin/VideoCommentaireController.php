...
class VideoCommentaireController extends AbstractController
{
    ...
    {
        return $this->render('admin/admin_video_commentaire/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_video_commentaire_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('admin/admin_video_commentaire/new.html.twig', [
    ...
    {
        return $this->render('admin/admin_video_commentaire/show.html.twig', [
            'video_commentaire' => $videoCommentaire,
        ]);
    }
    ...
    public function edit(Request $request, VideoCommentaire $videoCommentaire): Response
    {
        ...
        return $this->renderForm('admin/admin_video_commentaire/edit.html.twig', [
            'video_commentaire' => $videoCommentaire,
            'form' => $form,
        ]);
    }
